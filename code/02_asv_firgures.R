...
long_fractions <- readRDS('data/r_data/asv_long.RDS')
...
ggsave('out/asvs/figure1_v15.tiff' , dpi = 600)
ggsave('out/asvs/figure1.pdf', dpi=600)
...
ggsave('out/asvs/figure2.png', dpi = 600)
ggsave('out/asvs/figure2.tiff', dpi = 600)
...
ggsave('out/asvs/supplementary5.png', dpi=600)
...
ggsave('out/asvs/supplementary6.png', dpi=600)
...
individual <- ggplot(var_host_population, aes(x = person, y = var_person/var_population)) +
  ...
  coord_flip()
individual
ggsave('out/asvs/varPersonPopulation.tiff', dpi = 600)
ggsave('out/asvs/varPersonPopulation.png', dpi = 600)
...
otus
ggsave('out/asvs/varPersonPopulation_otu.tiff', dpi = 600)
ggsave('out/asvs/varPersonPopulation_otu.png', dpi = 600)
...
time
ggsave('out/asvs/logmiei_person_time.tiff', dpi = 600)
...
ggarrange(time + labs(tag = 'A')+theme(basze_size =12), host_population, common.legend = FALSE, nrow = 2, 
          heights = c(1, 0.8))
ggsave('out/asvs/figure3.png', dpi=600)
ggsave('out/asvs/figure3.tiff', dpi = 600)
...
ggsave('out/asvs/heatmap_byperson.png', height = 20, width = 20, units = 'cm', dpi=600)
